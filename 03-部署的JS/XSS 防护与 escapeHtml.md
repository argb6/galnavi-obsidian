...
| CSP | 严格的 script-src 白名单 | [内容安全策略 CSP](../06-安全与SEO/内容安全策略 CSP.md) |
| 外链安全 | noopener noreferrer | [外链跳转脚本（Redirect 倒计时）](外链跳转脚本（Redirect 倒计时）.md) |
| 内容类型 | nosniff 头 | [安全响应头](../06-安全与SEO/安全响应头.md) |
...
- 定义位置 → [数据预加载脚本（D1 载入）](数据预加载脚本（D1 载入）.md)
- CSP → [内容安全策略 CSP](../06-安全与SEO/内容安全策略 CSP.md)
