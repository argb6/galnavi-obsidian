...
| CSP | 严格的 script-src 白名单 | [[06-安全与SEO/内容安全策略 CSP]] |
| 外链安全 | noopener noreferrer | [[03-部署的JS/外链跳转脚本（Redirect 倒计时）]] |
| 内容类型 | nosniff 头 | [[06-安全与SEO/安全响应头]] |
...
- 调用方 → [[03-部署的JS/主应用逻辑脚本（卡片与交互）]]
- 定义位置 → [[03-部署的JS/数据预加载脚本（D1 载入）]]
